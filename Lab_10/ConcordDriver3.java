...
/**
 * Finds frequency of each word in a file. (Version for Exercise 3.)
 *
 * Optional command line argument is the threshold for the number of letters a
 * word must have to be printed with its number of occurrences.
 *
