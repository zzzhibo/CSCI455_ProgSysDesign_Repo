...
private:
  ...
  ListType *linkedChains; // pointer to linked chains
  unsigned int numNodes;  // number of nodes created

  int longestChain(ListType *in) const; //longest linked chain
  int nonEmpty(ListType *in) const;     // number of hash buckets filled
};
