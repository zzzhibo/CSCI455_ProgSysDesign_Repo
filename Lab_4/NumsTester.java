...
// Lab 4
/**
 * This class tests the Nums class. CS 455 Lab 4.
 */
...
public class NumsTester {
   ...
   /**
    * testFilter tests valuesGT method on nums with given threshold argument and
    * prints info about test performed and the results.
    */
   ...
   /**
    * Read a sequence of values from keyboard into nums variable, until we get to
    * an eof. If nums is non-empty beforehand, these values get added to the end of
    * the sequence already in nums. Does not error-check input.
    */
